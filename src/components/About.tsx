...
export default function About() {
  return (
    <section id="about" className="py-25 max-md:py-16">
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="grid grid-cols-2 gap-16 items-center max-md:grid-cols-1 max-md:gap-8">
          ...
          <AnimateOnScroll delay={0.1}>
            <div>
              <p className="text-[0.85rem] font-semibold text-gold uppercase tracking-[2px] mb-2">
                Tentang Kami
              </p>
              <h2
                className="font-[Playfair_Display] text-spice-dark mb-4"
                style={{ fontSize: "clamp(1.8rem, 4vw, 2.8rem)", lineHeight: 1.25 }}
              >
                Masakan Rote, Hati Kupang
              </h2>
